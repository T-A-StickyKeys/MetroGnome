...
public class TestScreen1 implements Screen {
    ...
    public TestScreen1(GameMain gameMain) {
        ...
        // load the assets
        parent.assets.loadAll(Test1Assets.values());
        parent.assets.manager.finishLoading();
        // assign the assets to their variables
        bgMusic = parent.assets.manager.get(Test1Assets.bgMusic.location());
        hitPaddle = parent.assets.manager.get(Test1Assets.hitPaddle.location());
        hitWall = parent.assets.manager.get(Test1Assets.hitWall.location());
        serve = parent.assets.manager.get(Test1Assets.score.location());
        score = parent.assets.manager.get(Test1Assets.score.location());
        paddleTexture = parent.assets.manager.get(Test1Assets.paddle.location());
        ballTexture = parent.assets.manager.get(Test1Assets.ball.location());
    ...
    private void processInputs() {
        ...
        if (controller.escape) {
            parent.changeScreen(parent.PAUSE, parent.TEST1);
        }
